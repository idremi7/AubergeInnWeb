	...
	<div class="container">
		...
		<div class="col-8 offset-2">
			<table class="table">
				...
				<tbody>
<%
					    List<TupleClient> clients = AubergeHelper.getAubergeInterro(session).getGestionClient()
					                .getListeClients();
...
<%
							    ...
							    List<TupleReserveChambre> reservations = a.getGestionReservation().listerToutesReservationClient(c.getIdClient());
